...
class PINN:
    ...
    def closure(self):
        ...
        self.iter += 1
        if self.iter % 200 == 0 and self.re < 1000 and self.loss.item()<10**(-3):
            self.re += 10
...
if __name__ == "__main__":
    ...
    torch.save(pinn.net.state_dict(), "adapt1000.pt")

    plotLoss(pinn.losses, "loss_curve_re_adapt_1.png", ["BC", "PDE"])
